<template>
	<b-navbar toggleable="md" class="app-header d-print-none">
		<b-navbar-nav class="navbar-nav-mobile ml-auto">
			...
			>
				<template slot="button-content">
					<i class="fi flaticon-message-circle px-2"></i>
				</template>
				<b-dropdown-item>
			...
			>
				<template slot="button-content">
					<i class="fi flaticon-settings-10 px-2"></i>
				</template>
			...
			<b-nav-item class="d-md-down-none" @click="loginOut">
