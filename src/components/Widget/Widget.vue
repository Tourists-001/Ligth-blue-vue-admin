	...
	export default {
		...
		mounted() {
			...
			if (this.customControls) {
				let close = this.$refs.customControlsRef.querySelector(
					"[control=close]"
				);
				close && close.addEventListener("click", this.closeWidget);
				let collapse = this.$refs.customControlsRef.querySelector(
					"[control=collapse]"
				);
				collapse &&
				...
				let expand = this.$refs.customControlsRef.querySelector(
					"[control=expand]"
				);
				expand &&
				...
				let restore = this.$refs.customControlsRef.querySelector(
					"[control=restore]"
				);
				restore &&
