<template>
	<div class="visits-page">
		...
		<b-row>
			<b-col xl="4" xs="12">
				<Widget title="<h6> USERBASE GROWTH </h6>" close settings customHeader>
					<div class="stats-row">
						<div class="stat-item">
			...
			<b-col xl="4" xs="12">
				<Widget title="<h6> TRAFFIC VALUES </h6>" close settings customHeader>
					<div class="stats-row">
						<div class="stat-item">
				...
				>
					<div class="widget-body">
						...
						<p class="fs-mini text-muted mb mt-sm">
							Target <span class="fw-semi-bold">$820</span> day earnings is
...
<script>
	...
	import AreaChart from "@/pages/Visits/components/AreaChart/AreaChart";
...
<style src="./Visits.scss" lang="scss"></style>
