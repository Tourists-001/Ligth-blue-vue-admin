<template>
	<div>
		...
		<h1 class="page-title">
			Message - <span class="fw-semi-bold">Notifications</span>
		</h1>

		<Widget title="<h6> Vue Toasted </h6>" close collapse settings customHeader>
			<b-row>
				<b-col lg="4" xs="12">
					...
					<div class="location-selector">
						<div class="bit top left" @click="toggleLocation('top-left')"></div>
						<div class="bit top right" @click="toggleLocation('top-right')" />
						<div class="bit top" @click="toggleLocation('top-center')" />
						<div
						...
						/>
						<div class="bit bottom" @click="toggleLocation('bottom-center')" />
					</div>
				</b-col>
